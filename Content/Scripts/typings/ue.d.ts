...
declare class SomChamadoCharacter extends Character { 
	CameraBoom: SpringArmComponent;
	FollowCamera: CameraComponent;
	BaseTurnRate: number;
	BaseLookUpRate: number;
	static GetDefaultObject(): SomChamadoCharacter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SomChamadoCharacter;
	static C(Other: UObject | any): SomChamadoCharacter;
}

declare class SomChamadoGameMode extends GameModeBase { 
	static GetDefaultObject(): SomChamadoGameMode;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SomChamadoGameMode;
	static C(Other: UObject | any): SomChamadoGameMode;
}
